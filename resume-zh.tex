...
\section{项目经验-其他}
\cvitem{vim、sublime plugin }{ vim-config(vim 配置，\lnk{https://github.com/chenxiaohui/vim_config})、vim-cscope(关联cscope，\lnk{https://github.com/chenxiaohui/vim_cscope})、ifdef-generator(生成ifdef，\lnk{https://github.com/chenxiaohui/ifdef_generator})、postreview.vim(生成post-review脚本，\lnk{https://github.com/chenxiaohui/post-review.vim})、file-list(文件管理器，\lnk{https://github.com/chenxiaohui/file-list})、AllinOneCompile(编译选项管理，\lnk{https://github.com/chenxiaohui/AllinOneCompile})、BufItv2(缓冲区管理，\lnk{https://github.com/chenxiaohui/Buf_Itv2})、generate-ref(sublime插件，生成参考文献\lnk{https://github.com/chenxiaohui/generate_ref})等}
\cvitem{python脚本 }{ 简历生成器（通过文本文件生成简历tex的generator)\lnk{https://github.com/chenxiaohui/resume})、category(分类电子书，\lnk{https://github.com/chenxiaohui/category})、music-category（分类音乐，\lnk{https://github.com/chenxiaohui/MusicCategory}），proxy-pool(爬取免费代理并验证，\lnk{https://github.com/chenxiaohui/proxy_pool})，scrawl(url规则爬虫，自动切换代理防止封ip)等}
\cvitem{其他项目}{ C0文法编译器(课程设计，C，\lnk{https://github.com/chenxiaohui/C0Compiler}）、正则表达式匹配器（课程设计，C++，\lnk{http://cxh.me/2011/03/22/implement-of-regular-expression-matcher/}）、中建地产企业产品线研发数据平台（实验室项目，LAMP)、某卫星地面测试系统（外包项目，MFC)，Admire系统网站的WebService封装（实验室项目，ASP.NET）、视频会议高清采集（实验室项目，VC/DirectShow）}
